...
typedef struct
{
  ...
  USB_Descriptor_Endpoint_t             HID_ReportOUTEndpoint_2;
...
enum InterfaceDescriptors_t
{
  ...
  INTERFACE_ID_Joystick_2 = 1, /**< Joystick interface descriptor ID */
};
...
#define JOYSTICK_IN_EPADDR_2  (ENDPOINT_DIR_IN  | 3)
#define JOYSTICK_OUT_EPADDR_2 (ENDPOINT_DIR_OUT | 4)
// HID Endpoint Size
